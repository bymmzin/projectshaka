...
export declare const makeRegistrationSocket: (config: SocketConfig) => {
    ...
    type: "md";
    ws: import("@whiskeysockets/baileys/lib/Socket/Client/mobile-socket-client").MobileSocketClient | import("@whiskeysockets/baileys/lib/Socket/Client/web-socket-client").WebSocketClient;
